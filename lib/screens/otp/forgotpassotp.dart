...
import 'package:phileclientapp/controllers/otp/Forgotpassotpctrlr.dart';

class ForgotPassOTP extends StatelessWidget {
  ForgotPassOtpCtrlr controller = Get.put(ForgotPassOtpCtrlr());
